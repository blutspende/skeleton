...
// TODO - limit, offset
func (s *messageService) GetUnprocessedMessageInsByInstrumentID(ctx context.Context, instrumentID uuid.UUID) ([]MessageIn, error) {
	return s.messageInRepository.GetUnprocessedByInstrumentID(ctx, instrumentID)
}
...
func (s *messageService) GetUnprocessedMessageOutsByInstrumentID(ctx context.Context, instrumentID uuid.UUID) ([]MessageOut, error) {
	// TODO - batching with limit+offset?
	return s.messageOutRepository.GetUnprocessedByInstrumentID(ctx, instrumentID)
}
