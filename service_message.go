...
type MessageService interface {
	...
	GetUnprocessedResultMessageIns(ctx context.Context, maxRetries, sentDaysBack, limit, offset int) ([]MessageIn, error)
	...
	GetUnprocessedMessageOuts(ctx context.Context, maxRetries, sentDaysBack, limit, offset int) ([]MessageOut, error)
...
func (s *messageService) GetUnprocessedResultMessageIns(ctx context.Context, maxRetries, sentDaysBack, limit, offset int) ([]MessageIn, error) {
	return s.messageInRepository.GetUnprocessedResultMessages(ctx, maxRetries, sentDaysBack, limit, offset)
}
...
func (s *messageService) GetUnprocessedMessageOuts(ctx context.Context, maxRetries, sentDaysBack, limit, offset int) ([]MessageOut, error) {
	return s.messageOutRepository.GetUnprocessed(ctx, maxRetries, sentDaysBack, limit, offset)
}
