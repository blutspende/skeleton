...
func (s *skeleton) GetUnprocessedMessageInsByInstrumentID(ctx context.Context, instrumentID uuid.UUID) ([]MessageIn, error) {
	return s.messageService.GetUnprocessedMessageInsByInstrumentID(ctx, instrumentID)
}

func (s *skeleton) GetUnprocessedMessageOutsByInstrumentID(ctx context.Context, instrumentID uuid.UUID) ([]MessageOut, error) {
	return s.messageService.GetUnprocessedMessageOutsByInstrumentID(ctx, instrumentID)
}
...
func (s *skeleton) SaveMessageOutOrder(ctx context.Context, messageOutOrder MessageOutOrder, analysisRequestIDs []uuid.UUID) (uuid.UUID, error) {
	panic("implement me")
}
...
func (s *skeleton) enqueueMessagesForArchiving(ctx context.Context) {
	//for {
	//	s.messageService.GetMessaIns
	//} // TODO...
}
