...
type CerberusClient interface {
	...
	SendControlResultBatch(controlResults []ControlResultTO) (ControlResultBatchResponse, error)
...
func (c *cerberusClient) SendControlResultBatch(controlResults []ControlResultTO) (ControlResultBatchResponse, error) {
