...
type skeletonCallbackHandlerV1Mock struct {
	...
	retriggerExamination       func(batchID uuid.UUID)
}
...
func (m *skeletonCallbackHandlerV1Mock) RetriggerExamination(batchID uuid.UUID) {
	if m.retriggerExamination == nil {
		return
	}
	m.retriggerExamination(batchID)
}
...
func (m *analysisServiceMock) RetriggerExamination(ctx context.Context, batchID uuid.UUID) {
}
