...
func TestSubmitAnalysisResult(t *testing.T) {
	...
	skeletonInstance, _ := skeleton.NewSkeleton(sqlConn, schemaName, migrator.NewSkeletonMigrator(), nil, analysisRepository, instrumentRepository, &cerberusClientMock)
	func() {
