...
func TestSubmitAnalysisResultWithoutRequests(t *testing.T) {
	...
	configuration := config.Configuration{
		...
		GetUnprocessedAnalysisRequestRetryMinute:   5,
		UnprocessedAnalysisRequestErrorRetryMinute: 5,
		GetUnprocessedAnalysisResultIDsRetryMinute: 5,
		UnprocessedAnalysisResultErrorRetryMinute:  5,
		GetUnprocessedControlResultIDsRetryMinute:  5,
	}
	...
	_, _ = dbConn.Exec(ctx, fmt.Sprintf(`INSERT INTO %s.sk_analyte_mappings(id, instrument_id, instrument_analyte, analyte_id, result_type)
	...
	_, _ = dbConn.Exec(ctx, fmt.Sprintf(`INSERT INTO %s.sk_channel_mappings(id, instrument_channel, channel_id, analyte_mapping_id)
...
func (m *analysisRepositoryMock) GetAnalysisRequestsBySampleCodes(ctx context.Context, sampleCodes []string, allowResending, allowDeleted bool) (map[string][]AnalysisRequest, error) {
	return nil, nil
}
...
func (m *analysisRepositoryMock) GetControlReagentRelationsByControlResultIDs(ctx context.Context, controlIDs []uuid.UUID) (map[uuid.UUID][]uuid.UUID, error) {
	return nil, nil
}
func (m *analysisRepositoryMock) GetAnalysisResultIDsNotSavedIntoCerberusByAnalysisResultIDs(ctx context.Context, analysisResultIDs []uuid.UUID) ([]uuid.UUID, error) {
	return m.analysisResultIDsNotSavedToCerberus, nil
}
func (m *analysisRepositoryMock) UpdateControlResultBatchWithExpectedControl(ctx context.Context, controlResults []ControlResult) error {
	return nil
}
...
func (m *analysisRepositoryMock) CreateTransaction(ctx context.Context) (db.DbConnection, error) {
