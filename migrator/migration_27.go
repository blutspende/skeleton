...
const migration_27 = `
	CREATE TABLE <SCHEMA_PLACEHOLDER>.sk_message_in_sample_codes (
	    ...
	    CONSTRAINT sk_pk_message_sample_codes PRIMARY KEY (id),
	...
	CREATE INDEX sk_idx_message_in_sample_codes_modified_at ON <SCHEMA_PLACEHOLDER>.sk_message_in_sample_codes (modified_at);
	...
	CREATE INDEX sk_idx_message_out_sample_codes_modified_at ON <SCHEMA_PLACEHOLDER>.sk_message_out_sample_codes (modified_at);
