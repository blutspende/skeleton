...
type Configuration struct {
	...
	MessageRetryTimeoutSeconds                  int           `envconfig:"MESSAGE_RETRY_TIMEOUT_SECONDS" default:"30"`
	...
	TCPServerConnectionInitiationTimeoutSeconds uint16        `envconfig:"TCP_CONNECTION_INITIATION_TIMEOUT_SECONDS" default:"30"`
